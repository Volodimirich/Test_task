# Мы работаем с отсортированным массивом и ищем первую позицию 1. Данная задача сводится к бинарному поиску.
# В общем случае время работы также зависит от временной сложности isBrokenVersion - O(logn) * O(isBrokenVersion)
